        ...
        <div class="screen">
            <div class="screen__content">
                <form id="formulario" class="login" v-on:submit.prevent="login">
                    <h3 id="titulo">BIENVENIDO</h3>
                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="text" class="login__input" placeholder="Usuario" v-model="usuario">
                    </div>
                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" class="login__input" placeholder="Contraseña" v-model="contrasena">
                    </div>
                    <div v-if="error==true" class="alert alert-danger" role="alert">
                        Usuario no existe
                    </div>
                    <div v-else-if="error2==true" class="alert alert-danger" role="alert">
                        Contraseña incorrecta
                    </div>
                    <button class="button login__submit">
                        <span style="width: 100%;" class="button__text">Ingresar</span>
                        <i class="button__icon fas fa-chevron-right"></i>
                    </button>
                    <h5 id="olvido">¿Olvido su contraseña?</h5>
                </form>
